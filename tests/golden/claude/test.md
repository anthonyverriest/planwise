...
- **Free text** — anything else. Resolve to files by searching the codebase (grep, glob, project structure). Ask the user if ambiguous: "I found N files matching '<ARGS>'. Which should I target?"
