...
Assemble the feature body through `AskUserQuestion` dialogue — User Story, Success Criteria, Scope, Key Assumptions & Risks, Technical Context. One focused round per section; do not move on until the section is clear.
...
Use `AskUserQuestion`: **"Ready to create issues, or stop here?"**
